...
int main()
{
	...
	*/
	...
	for (int i = 0; i < iLine; ++i)
	{
		...
		// i값이 7줄 기준 4,5,6 즉 밑의 삼각형을 구성할떄만 if문이 들어가게 된다
		if (i >= iLine / 2)
		{
			iCount = iLine - 1 - i;
		}

		// i값이 0,1,2,3 일때는 iCount값이 그대로 대입된다
		// i값이 4,5,6 일 떄는 iCount는 2,1,0이 된다
		// 즉, 최종 i값은 0으로 돌아가게 된다
